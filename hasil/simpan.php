<?php
	...
	$tambah = "INSERT INTO hasil SET pendaftar_id='$pendaftar', jurusan_id='$jurusan', nilai_tpa='$nilai_tpa', nilai_wawancara='$nilai_wawancara', nilai_uan='$nilai_uan', nilai_minat='$nilai_minat', nilai_rata='$rata', penguji_id='$penguji', tahun_ajaran='$tahun_ajaran', keterangan='$keterangan'";
